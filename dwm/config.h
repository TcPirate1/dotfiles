...
static const char col_cyan[]        = "#A300A3";
...
// ctrl+a to capture entire screen, esc to leave any flameshot window
static const char *flameshot_config[] = { "flameshot", "config", NULL };
static const char *dwm_music_playlist[] = { "mpv", "--player-operation-mode=pseudo-gui", "--playlist=~/Music/playlist.m3u", "--shuffle", NULL };
